...
axs[0,2].plot(x_leontief, (obj_mogd_leontief_low[0] - obj_mogd_leontief_low[-1])*(x_leontief**(-1/2)) + obj_mogd_leontief_low[-1]+ 1, color='red', linestyle='dashed', label = "1/sqrt(T)")
...
axs[1,0].plot([iter for iter in range(num_iters_linear)], obj_msgd_linear_high, label = "Nested Gradient Descent Ascent", linestyle='dashed', alpha = 1, color = "orange")
# axs[0,0].plot(x, (obj_mogd_linear[0]/15)/x + obj_mogd_linear[-1], color='green', linestyle='dashed', label = "1/T")
axs[1,0].plot(x_linear, (obj_mogd_linear_high[0] - obj_mogd_linear_high[-1])*(x_linear**(-1/2)) + obj_mogd_linear_high[-1], color='red', linestyle='dashed', label = "1/sqrt(T)")
...
axs[1,2].plot([iter for iter in range(num_iters_leontief)], obj_msgd_leontief_high, label = "Nested Gradient Descent Ascent", linestyle='dashed', alpha = 1, color = "orange")
# axs[1,0].plot(x, (obj_mogd_leontief[0]/4)/x + obj_mogd_leontief[-1], color='green', linestyle='dashed', label = "1/T")
axs[1,2].plot(x_leontief, (obj_mogd_leontief_high[0] - obj_mogd_leontief_high[-1])*(x_leontief**(-1/2)) + obj_mogd_leontief_high[-1] -5 , color='red', linestyle='dashed', label = "1/sqrt(T)")
